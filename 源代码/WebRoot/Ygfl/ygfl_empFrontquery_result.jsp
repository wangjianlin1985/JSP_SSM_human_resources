...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>福利年份</td><td>福利奖金</td><td>是否发放</td><td>发放日期</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="ygflQueryForm" id="ygflQueryForm" action="<%=basePath %>Ygfl/empFrontlist" class="mar_t15" method="post">
