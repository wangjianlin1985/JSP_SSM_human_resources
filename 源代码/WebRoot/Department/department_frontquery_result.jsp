				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>部门编号</td><td>部门名称</td><td>成立日期</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="department_zhizhe_edit" class="col-md-3 text-right">部门职责:</label>
		  	 <div class="col-md-9">
			    <textarea id="department_zhizhe_edit" name="department.zhizhe" rows="8" class="form-control" placeholder="请输入部门职责"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (department, response, status) {
			if (department) {
				...
				$("#department_zhizhe_edit").val(department.zhizhe);
