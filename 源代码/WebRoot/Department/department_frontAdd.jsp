				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="departmentAdd"> 
						  ...
						  <div class="form-group">
							 <label for="department_departmentNo" class="col-md-2 text-right">部门编号:</label>
							 <div class="col-md-8"> 
							 	<input type="text" id="department_departmentNo" name="department.departmentNo" class="form-control" placeholder="请输入部门编号">
							 </div>
						  </div> 
						  <div class="form-group">
						  ...
						  <div class="form-group">
						  	 <label for="department_zhizhe" class="col-md-2 text-right">部门职责:</label>
						  	 <div class="col-md-8">
							    <textarea id="department_zhizhe" name="department.zhizhe" rows="8" class="form-control" placeholder="请输入部门职责"></textarea>
							 </div>
						  </div>
						  <div class="form-group">
