		       ...
		       text: "公司培训管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Train/train_add.jsp"
			    	   	},
			    		{
			    	   		text: "公司培训管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Train/train_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "员工薪酬管理",
		       ...
		       text: "绩效考核管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Jixiao/jixiao_add.jsp"
			    	   	},
			    		{
			    	   		text: "绩效考核管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Jixiao/jixiao_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "员工福利管理",
			    	   ...
			    	   [
			    	    {
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Ygfl/ygfl_make.jsp"
			    	   	},
			    		{
			    	   		text: "员工福利管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Ygfl/ygfl_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "员工奖惩管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Ygjc/ygjc_add.jsp"
			    	   	},
			    		{
			    	   		text: "员工奖惩管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Ygjc/ygjc_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "员工合同管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Contract/contract_add.jsp"
			    	   	},
			    		{
			    	   		text: "员工合同管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Contract/contract_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
