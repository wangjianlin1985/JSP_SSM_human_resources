...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">人力资源系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
               <!--  <li><a href="<%=basePath %>index.jsp">首页</a></li>
                ...
                <li><a href="<%=basePath %>Job/frontlist">岗位招聘</a></li>
                <li><a href="<%=basePath %>Train/frontlist">公司培训</a></li>
                <li><a href="<%=basePath %>Salary/frontlist">员工薪酬</a></li>
                <li><a href="<%=basePath %>Jixiao/frontlist">绩效考核</a></li>
                <li><a href="<%=basePath %>Ygfl/frontlist">员工福利</a></li>
                <li><a href="<%=basePath %>Ygjc/frontlist">员工奖惩</a></li>
                <li><a href="<%=basePath %>Contract/frontlist">员工合同</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Salary/empFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的薪酬查询</a></li>
                        <li><a href="<%=basePath %>Jixiao/empFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的绩效考核</a></li>
                        <li><a href="<%=basePath %>Ygfl/empFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的福利信息</a></li>
                        <li><a href="<%=basePath %>Ygjc/empFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的奖惩激励</a></li>
