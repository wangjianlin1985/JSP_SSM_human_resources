	...
	<div class="col-md-9 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Employee/<%=employee.getEmployeeNo() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=employee.getEmpPhoto()%>" /></a>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="employeeQueryForm" id="employeeQueryForm" action="<%=basePath %>Employee/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="positionName" name="positionName" value="<%=positionName %>" class="form-control" placeholder="请输入职位名称">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="employee_positionName_edit" class="col-md-3 text-right">职位名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="employee_positionName_edit" name="employee.positionName" class="form-control" placeholder="请输入职位名称">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    ...
			    <input type="hidden" id="employee_empPhoto" name="employee.empPhoto"/>
			    <input id="empPhotoFile" name="empPhotoFile" type="file" size="50" />
		  	 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="employee_jianli_edit" class="col-md-3 text-right">个人简历:</label>
		  	 <div class="col-md-9">
			 	<textarea name="employee.jianli" id="employee_jianli_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="employee_regTime_edit" class="col-md-3 text-right">注册时间:</label>
		  	 <div class="col-md-9">
                <div class="input-group date employee_regTime_edit col-md-12" data-link-field="employee_regTime_edit">
                    <input class="form-control" id="employee_regTime_edit" name="employee.regTime" size="16" type="text" value="" placeholder="请选择注册时间" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                </div>
		  	 </div>
...
<script>
//实例化编辑器
var employee_jianli_edit = UE.getEditor('employee_jianli_edit'); //个人简历编辑器
	...
	$.ajax({
		...
		success : function (employee, response, status) {
			if (employee) {
				...
				$("#employee_empPhoto").val(employee.empPhoto);
				$("#employee_empPhotoImg").attr("src", basePath +　employee.empPhoto);
				$("#employee_telephone_edit").val(employee.telephone);
				$("#employee_address_edit").val(employee.address);
				employee_jianli_edit.setContent(employee.jianli, false);
				$("#employee_regTime_edit").val(employee.regTime);
...
$(function(){
    ...
    /*注册时间组件*/
    $('.employee_regTime_edit').datetimepicker({
    	language:  'zh-CN',  //语言
