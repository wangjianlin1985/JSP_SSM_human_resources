...
public class DepartmentController extends BaseController {
	...
	public void list(String bornDate,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		if (page==null || page == 0) page = 1;
		if (bornDate == null) bornDate = "";
		if(rows != 0)departmentService.setRows(rows);
		List<Department> departmentList = departmentService.queryDepartment(bornDate, page);
	    /*计算总的页数和总的记录数*/
	    departmentService.queryTotalPageAndRecordNumber(bornDate);
	    /*获取到总的页码数目*/
	...
	public String frontlist(String bornDate,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (bornDate == null) bornDate = "";
		List<Department> departmentList = departmentService.queryDepartment(bornDate, currentPage);
	    /*计算总的页数和总的记录数*/
	    departmentService.queryTotalPageAndRecordNumber(bornDate);
	    /*获取到总的页码数目*/
	    int totalPage = departmentService.getTotalPage();
	...
	public void OutToExcel(String bornDate, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        if(bornDate == null) bornDate = "";
        List<Department> departmentList = departmentService.queryDepartment(bornDate);
