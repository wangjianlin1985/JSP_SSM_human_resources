...
public class EmployeeService {
    ...
    /*按照查询条件分页查询员工记录*/
    public ArrayList<Employee> queryEmployee(String employeeNo,Department departmentObj,String positionName,String name,String birthDate,String telephone,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Employee> queryEmployee(String employeeNo,Department departmentObj,String positionName,String name,String birthDate,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!employeeNo.equals("")) where = where + " and t_employee.employeeNo like '%" + employeeNo + "%'";
    	if(null != departmentObj &&  departmentObj.getDepartmentNo() != null && !departmentObj.getDepartmentNo().equals(""))  where += " and t_employee.departmentObj='" + departmentObj.getDepartmentNo() + "'";
    	if(!positionName.equals("")) where = where + " and t_employee.positionName like '%" + positionName + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String employeeNo,Department departmentObj,String positionName,String name,String birthDate,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!employeeNo.equals("")) where = where + " and t_employee.employeeNo like '%" + employeeNo + "%'";
    	if(null != departmentObj &&  departmentObj.getDepartmentNo() != null && !departmentObj.getDepartmentNo().equals(""))  where += " and t_employee.departmentObj='" + departmentObj.getDepartmentNo() + "'";
    	if(!positionName.equals("")) where = where + " and t_employee.positionName like '%" + positionName + "%'";
