...
public class DepartmentService {
    ...
    /*按照查询条件分页查询部门记录*/
    public ArrayList<Department> queryDepartment(String bornDate,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Department> queryDepartment(String bornDate) throws Exception  { 
     	String where = "where 1=1";
    	if(!bornDate.equals("")) where = where + " and t_department.bornDate like '%" + bornDate + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String bornDate) throws Exception {
     	String where = "where 1=1";
    	if(!bornDate.equals("")) where = where + " and t_department.bornDate like '%" + bornDate + "%'";
